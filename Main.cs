...
namespace FSL_Manager
{
    ...
    {
        private string iniPath = Path.Combine(
        ...
        private void LoadConfig()
        {
            ...
            {
                string l = line.Trim();
                if (l.StartsWith("sourceDLL"))
                {
                    int i = l.IndexOf("=");
                    if (i >= 0) sourceDLL = l.Substring(i + 1).Trim().Trim('"');
                }
                else if (l.StartsWith("gameFolder"))
                {
                    int i = l.IndexOf("=");
                    if (i >= 0) gameFolder = l.Substring(i + 1).Trim().Trim('"');
                }
            }
